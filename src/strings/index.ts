...
interface S<Input extends Stringifiable, Value extends string = ToString<NoInfer<Input>>> {
  /**
  ...
  /** @alias S.toCamelCase */
  camel(options?: CasingOptions): S<string>;
  ...
  /** @alias S.toKebabCase */
  kebab(options?: CasingOptions): S<string>;
  ...
  /** @alias S.toLowerCase */
  lower(): S<Lowercase<ToString<Value>>>;
  ...
  pascal(options?: CasingOptions): S<string>;

  /** @alias S.toPascalCase */
  toUpperCamelCase(options?: CasingOptions): S<string>;
  ...
  /** @alias S.toSnakeCase */
  snake(options?: CasingOptions): S<string>;
  ...
  /** @alias S.toUpperCase */
  upper(): S<Uppercase<ToString<Value>>>;
  ...
  /** @alias S.truncateEnd */
  ellipsis(length: number, ellipsis?: Stringifiable): S<string>;
...
assignMethods(S, instanceMethods, false);
assignMethods(S, chainableMethods, true);

const SWithMethods = Object.assign(S, staticMethods, instanceMethods, chainableMethods);
