...
export { isAsyncFunction } from "./methods/isAsyncFunction";
export { isAsyncGeneratorFunction } from "./methods/isAsyncGeneratorFunction";
export { isBindable } from "./methods/isBindable";
export { isBound } from "./methods/isBound";
export { isConstructible } from "./methods/isConstructible";
...
export { tryCatchAsync } from "./methods/tryCatchAsync";
